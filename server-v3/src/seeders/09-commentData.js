...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert("Comments", [{
      ...
      linkedPostTitle: "Welcome-to-Inspired-by-blog",
      contents: "Hi, I'm manager of inspired-by website.",
      ...
      contents: "Is there any comment here?",
      authorId: "63b54c93-635b-42ef-bc83-388debf6fa64",
      createdAt: Sequelize.fn('NOW'),
      updatedAt: Sequelize.fn('NOW')
    }, {
      ...
      linkedPostTitle: "This-is-a-seeded-post",
      contents: "Nada. Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum.",
      authorId: "63b54c93-635b-42ef-bc83-388debf6fa64",
      createdAt: Sequelize.fn('NOW'),
      updatedAt: Sequelize.fn('NOW')
    }])
